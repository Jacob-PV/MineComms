...
class Connection2 : AppCompatActivity() {
...
//    private fun send(toEndpointId: String, fileName: String) {
//        val fileToSend = File(context.filesDir, fileName)
//        try {
...
//                storedFile.writeBytes(imageFile!!.readBytes())
//            }
//
...
//        }
//        else {
//            Log.d("SEND FUNC", "NO IMAGE TO SEND")
